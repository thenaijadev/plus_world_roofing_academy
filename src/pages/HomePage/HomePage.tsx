    ...
    <div id="main">
      ...
      <section className="hero p-5 ">
        <div className="hero_description w-50 ps-5">
          <h1 className="mb-4">
            Never Stop <span>Learning!</span> <br />
            Launch a new long term career with us.
          </h1>
          <h6 className="mb-4">
            Every teaching and learning journey is unique and <br /> we will
      ...
      <section className="px-5 pt-5 my-5" id="get-more">
        <div className="d-flex flex-column flex-md-row align-items-center justify-content-center gap-5">
          ...
          <div className="more_about_us px-3">
            ...
            <p className="mt-2 mb-4 fw-medium">
              Learn creative skills to achieve your <br />
            ...
            <div className="d-flex gap-3 align-items-center mb-3">
              <img
                src={ArrowRight}
                alt="arrow right"
                className="p-2 border-black border arrrow_right rounded-circle"
              />
          ...
          <NavItem className="cursor-pointer">
            <NavLink
              className={classnames({
                active: activeTab === "Roofing_Construction",
              })}
              onClick={() => {
        ...
        <div>
          <div className="tutor d-flex flex-column flex-md-row align-items-center justify-content-between my-5 px-2 m-auto">
            <div>
              ...
              <h4 className="mb-4 fs-3">
                Learn from <br /> creative experts{" "}
              </h4>
              <p className="mb-4">
                classes are taught by industry <br /> leaders excited to share
                their tools, techniques, and professional journeys with you.
              </p>
              <IconButton
                title="See All Instructors"
                image={ArrowFowardSmall}
              />
            </div>
            <div className="d-flex flex-wrap align-items-center justify-content-around">
              <ExpertAvatarCard
                avatar={OliviaMiaAvatar}
                name="Olivia Mia"
                title="Roofing Design"
                reviews="(4.8 Reviews)"
              />
              <ExpertAvatarCard
                avatar={OliviaMiaAvatar}
      ...
      <section className=" pt-5 my-5">
        <div className="text-center testimonial_heading">
          ...
          <p>
            Skillshare is here to support you on every step of your creative
            journey.
          </p>
        </div>
        ...
        <div className="d-flex flex-column flex-md-row gap-5 mx-5 px-4 align-items-center justify-content-around">
          ...
          <div className="w-75">
            <h4 className="fs-2 mb-3">
              Want to stay informed about <br /> <span>new courses</span> and
              study?
            </h4>
            <form action="">
              <div className=" d-flex flex-column flex-md-row gap-1 ">
                ...
                />
                <button type="button" className="btn fw-medium rounded-pill">
                  Subscribe Now
                </button>
              </div>
            </form>
              ...
              <Accordion flush open={open} toggle={toggleAccordion}>
                <AccordionItem className="border-black">
                  ...
                  <AccordionBody accordionId="1">
                    ...
                    Sed amet, sequi similique rerum unde necessitatibus,
                    excepturi magni, consequatur fugiat expedita distinctio?
                    Quam accusamus vitae rem nisi esse molestiae amet
                    laboriosam.
                  </AccordionBody>
                </AccordionItem>
                <AccordionItem className="border-black">
