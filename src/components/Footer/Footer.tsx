        ...
        <div className='py-2'>
            <div className='d-flex justify-content-around pt-5 pb-3 align-items-start  border-bottom mx-5 border-2'>
                <div className='d-flex flex-column gap-4 address'>
                    ...
                    <p className='mb-0 fw-medium'>Plusworld Academy LMS <br />+2348126708162 20 Ojomo royal <br /> plaza, Lekki-Epe </p>
                    <p className='fw-medium'>plusworldacademy@gmail.com <br />Expressway, Lagos-Nigeria.</p>
                    <div className='d-flex align-items-center justify-content-between ms-0'>
                        <SocialIcon imgage={Instagram}/>
                        <SocialIcon imgage={Twitter}/>
                        <SocialIcon imgage={LinkedIn}/>
                        <SocialIcon imgage={Facebook}/>
                        <SocialIcon imgage={YouTube}/>
                    </div>
                </div>
